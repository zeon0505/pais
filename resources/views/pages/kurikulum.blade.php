...
<div class="space-y-10">
  ...
  <div class="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm space-y-4">
    <div class="flex items-start gap-4">
      ...
      <div>
        <h2 class="font-bold text-gray-800 text-xl">Kurikulum S1 Pendidikan Agama Islam</h2>
        <p class="text-gray-500 text-sm mt-1 leading-relaxed">Kurikulum PAI dirancang untuk menghasilkan lulusan yang kompeten dalam bidang pengajaran agama Islam, menguasai ilmu pedagogik, serta memiliki jiwa edupreneurship yang kuat. Beban studi diselesaikan dalam 8 semester (4 tahun).</p>
      </div>
    </div>
  </div>
  ...
  <div class="space-y-4">
    ...
    $semesters = [
      ...
      3 => ['Tafsir Tarbawi', 'Hadits Tarbawi', 'Psikologi Pendidikan', 'Kurikulum PAI', 'Perencanaan Pembelajaran', 'Ilmu Kalam', 'Ilmu Tasawuf'],
      4 => ['Strategi Pembelajaran PAI', 'Evaluasi Pembelajaran', 'Media Pembelajaran', 'Fiqih Munakahat', 'Ushul Fiqih', 'Metodologi Studi Islam'],
      5 => ['Micro Teaching', 'Bimbingan Konseling', 'Manajemen Pendidikan', 'Fiqih Muamalah', 'Edupreneurship I', 'Penelitian Pendidikan'],
      6 => ['PPL I', 'Kajian Kitab Kuning', 'Pendidikan Inklusi', 'Edupreneurship II', 'KKN', 'Kapita Selekta PAI'],
  ...
  <div class="bg-gray-100/70 border border-gray-200/50 rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
    <div class="flex items-center gap-4">
      ...
      <div>
        <h4 class="font-bold text-gray-800 text-lg">Dokumen Lengkap Kurikulum PAI</h4>
