@extends('layouts.app')
@section('title', $poster->judul . ' - Prodi PAI STAIMAS')
          ...
          <div class="flex items-center justify-between border-b border-gray-100 pb-4">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-full bg-teal-50 border border-teal-500/30 p-0.5 flex items-center justify-center shrink-0">
                <img src="{{ asset('assest/Kaprodi PAI.png') }}" alt="PAI Logo" class="w-full h-full object-contain rounded-full">
              </div>
              <div class="leading-tight">
                <div class="flex items-center gap-1.5">
                  <span class="font-extrabold text-gray-900 text-sm">prodipai_staimas</span>
                  <i class="fas fa-check-circle text-teal-600 text-xs" title="Akun Resmi PAI"></i>
                </div>
                <span class="text-[11px] text-gray-400 font-medium block">Prodi PAI &bull; {{ $poster->created_at->isoFormat('D MMMM Y') }}</span>
              </div>
            </div>
          </div>
