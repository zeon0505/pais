...
<div class="max-w-6xl mx-auto space-y-6">
  ...
  <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-1 sm:p-2">
    <iframe
      src="https://docs.google.com/gview?url={{ urlencode(asset('assest/Sertifikat Akreditasi PAI.pdf')) }}&embedded=true"
      class="w-full"
      style="height: 78vh; min-height: 550px; border: none;"
      title="Sertifikat Akreditasi PAI">
    </iframe>
  </div>

  {{-- Tombol Aksi di Bawah --}}
  <div class="flex justify-center gap-3">
    <a href="{{ asset('assest/Sertifikat%20Akreditasi%20PAI.pdf') }}" target="_blank"
    ...
    <a href="{{ asset('assest/Sertifikat%20Akreditasi%20PAI.pdf') }}" download
